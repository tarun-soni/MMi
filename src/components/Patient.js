...
class Patient extends React.Component {
  ...
  async loadBlockchainGetData() {
    ...
    /*
      ...
      */
    const savePass = await this.state.contract.methods
      .getPatientPass(this.state._id)
      .call();
      ...
      <div>
        <div className="container">
          ...
          <Form isopen={this.state.isopen}>
            <form
              className="formBorder2 center-block modal-body"
              onSubmit={(event) => {
                event.preventDefault();
            ...
            >
              ...
              <button type="submit" className="ops btn btn-block">
                Save Info
              </button>
              <hr />
              <button
                className="ops btn btn-block"
                onClick={(event) => {
